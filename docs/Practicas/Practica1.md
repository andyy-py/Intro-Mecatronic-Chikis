...
## Desarrollo
![Circuito armado en físico sobre la protoboard con sus componentes y conexiones.](./img_practica_1/555.jpg){ width=50% } <br>
*Circuito armado en físico sobre la protoboard con sus componentes y conexiones.* <br>

![Simulación del circuito armado en la plataforma Tinkercad.](./img_practica_1/digital.jpg){ width=50% } <br>
