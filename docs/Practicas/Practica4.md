...
![Eje X: lectura ADC, Eje Y: ángulo de referencia.](./img_practica_4/Imagen1.png){ width=50% }
![Eje X: lectura ADC, Eje Y: ángulo de referencia.](./img_practica_4/Imagen2.png){ width=50% } <br>
...
![Ángulo cambia a 67.5 y marca diferente ADC](./img_practica_4/Captura1.png){ width=50% }
![Ángulo cambia a 67.5 y marca diferente ADC](./img_practica_4/Imagen3.png){ width=50% } <br>
